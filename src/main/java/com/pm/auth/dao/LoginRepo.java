...
public interface LoginRepo extends CrudRepository<PmUsers,Long>{
	...
	@Query(value = "select new com.pm.common.beans.UserWrapper(u.userId, u.firstName, u.lastName, u.email, u.mobileNo, u.userName, u.userStts, u.rating) "
			+ "from PmUsers u where u.mobileNo = :mbl")
