...
public interface UserRepository extends CrudRepository<PmUsers, Long> {
	...
	@Query(value = "select new com.pm.common.beans.UserWrapper(u.userId, u.firstName, u.lastName, u.fullName, u.email, "
			+ "u.mobileNo, u.userName, u.userStts, u.rating, u.image, u.userAddress) from PmUsers u where u.userId = :id")
